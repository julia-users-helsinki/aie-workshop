...
# ╔═╡ e2c2ae48-87cf-49e0-8ec5-b93bc41f2a21
begin
	using ModelingToolkit, DifferentialEquations, Plots
end

# ╔═╡ 4bc1b007-b3cf-4172-80b2-d52e2f1346df
begin
	using Optimization, OptimizationPolyalgorithms, SciMLSensitivity, ForwardDiff
end

# ╔═╡ 6113bbcf-badd-47ec-b476-380cdbd0da94


# ╔═╡ bd7d5f14-173a-11ef-083d-3120bfac0bc7
md"""
# Differential equations in Julia

Julia has an extremely rich ecosystem for differential equations, wrapping C and fortran solvers plus adding new cutting edge ones.

Furthermore, thanks to Julia composability, training Physics-Informed Neural Networks (PINN) is extremely simple.

For a complete overview of the ecosystem, with documentation adn showcases, see the [SciML website](sciml.ai).
"""

# ╔═╡ 88b4fafd-fc52-4f54-a449-84efebe8f561
md"""

"""

# ╔═╡ c4b5c6b2-205d-4772-9a64-761f09b69949
let
...
# ╔═╡ 266f01de-b60d-457d-80f1-3172caf2c8b4
let
...
manifest_format = "2.0"
project_hash = "f354af5e9e9267d766dac8bacf5065e22e78413a"
